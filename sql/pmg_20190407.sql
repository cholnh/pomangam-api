...
INSERT INTO `authority_tbl` VALUES (1,'cholnh','ROLE_ADMIN'),(2,'admin','ROLE_ADMIN'),(3,'test','ROLE_USER');
...
CREATE TABLE `cart_tbl` (
  ...
  CONSTRAINT `fk_cart_customer` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `cart_tbl` VALUES (1,1,1,'2019-04-05');
...
CREATE TABLE `comment_for_all_tbl` (
  ...
  CONSTRAINT `comment_customer_fk` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `comment_for_store_tbl` (
  ...
  CONSTRAINT `fk_cs_cust` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='카트 내 물품 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `item_for_cart_tbl` VALUES (1,1,1,1,2,NULL,NULL),(2,1,2,1,1,NULL,1),(3,1,3,2,4,NULL,NULL),(4,1,3,2,1,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='주문 항목 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `item_for_order_tbl` VALUES (1,1,1,1,1,'x',NULL),(2,2,1,10,1,'x',1),(3,3,2,4,2,NULL,NULL),(4,4,1,2,1,NULL,NULL),(5,5,3,7,2,NULL,NULL),(6,6,3,8,1,NULL,NULL),(7,7,1,2,1,NULL,NULL),(8,7,3,5,1,NULL,NULL),(9,8,2,6,2,NULL,NULL),(10,8,3,8,1,NULL,NULL),(11,9,1,1,1,'x',NULL),(12,10,1,1,1,'x',NULL),(13,11,2,4,2,NULL,NULL),(14,12,1,2,1,NULL,NULL),(15,13,3,7,2,NULL,NULL),(16,14,3,8,1,NULL,NULL),(17,15,1,2,1,NULL,NULL),(18,15,3,5,1,NULL,NULL),(19,16,2,6,2,NULL,NULL),(20,16,3,8,1,NULL,NULL),(21,17,4,4,1,'x',NULL),(22,18,4,4,1,'x',NULL),(23,19,5,5,2,NULL,NULL),(24,20,4,4,1,NULL,NULL),(25,21,6,6,2,NULL,NULL),(26,22,6,6,1,NULL,NULL),(27,23,4,4,1,NULL,NULL),(28,23,6,6,1,NULL,NULL),(29,24,5,5,2,NULL,NULL),(30,24,6,6,1,NULL,NULL),(31,25,4,4,1,'x',NULL),(32,26,4,4,1,'x',NULL),(33,27,5,5,2,NULL,NULL),(34,28,4,4,1,NULL,NULL),(35,29,6,6,2,NULL,NULL),(36,30,6,6,1,NULL,NULL),(37,31,4,4,1,NULL,NULL),(38,31,6,6,1,NULL,NULL),(39,32,5,5,2,NULL,NULL),(40,32,6,6,1,NULL,NULL),(41,33,1,1,4,NULL,NULL),(42,33,2,1,2,NULL,NULL);
...
CREATE TABLE `like_for_comment_all_tbl` (
  ...
  CONSTRAINT `fk_like_customer_all` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `like_for_reply_all_tbl` (
  ...
  CONSTRAINT `fk_like_reply_customer_all` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `like_for_reply_store_tbl` (
  ...
  CONSTRAINT `fk_like_reply_customer_store` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `log_for_coupon_tbl` (
  ...
  CONSTRAINT `fk_cl_cust` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `log_for_order_tbl` (
  ...
  CONSTRAINT `fk_lo_cust` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `log_for_point_tbl` (
  ...
  CONSTRAINT `fk_pl_cust` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `oauth_access_token` VALUES ('ba7a8a973fc4a37dbb846e3c1820d50d','�\�\0sr\0Corg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2AccessToken��6$�\�\0L\0additionalInformationt\0Ljava/util/Map;L\0\nexpirationt\0Ljava/util/Date;L\0refreshTokent\0?Lorg/springframework/security/oauth2ClientDetail/common/OAuth2RefreshToken;L\0scopet\0Ljava/util/Set;L\0	tokenTypet\0Ljava/lang/String;L\0valueq\0~\0xpsr\0java.util.Collections$EmptyMapY6�Z\�\�\�\0\0xpsr\0java.util.Datehj�KYt\0\0xpw\0\0iG,�Wxsr\0Lorg.springframework.security.oauth2ClientDetail.common.DefaultExpiringOAuth2RefreshToken/\�Gc�\�ɷ\0L\0\nexpirationq\0~\0xr\0Dorg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2RefreshTokens\�\ncT\�^\0L\0valueq\0~\0xpt\0$7a7042f4-f4e2-426d-abbe-400d65ff95edsq\0~\0	w\0\0i\��Vxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0ct\0Ljava/util/Collection;xpsr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxt\0bearert\0$0b3bd8e5-ddd8-4f11-8f2d-75fd67a6bef1','d39f7e5d335eb9c128c796f072d156dc','admin','admin','�\�\0sr\0Aorg.springframework.security.oauth2ClientDetail.provider.OAuth2Authentication�@bR\0L\0\rstoredRequestt\0<Lorg/springframework/security/oauth2ClientDetail/provider/OAuth2Request;L\0userAuthenticationt\02Lorg/springframework/security/core/Authentication;xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailst\0Ljava/lang/Object;xp\0sr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0w\0\0\0sr\0Borg.springframework.security.core.authority.SimpleGrantedAuthority\0\0\0\0\0\0�\0L\0rolet\0Ljava/lang/String;xpt\0	ROLE_USERxq\0~\0psr\0:org.springframework.security.oauth2ClientDetail.provider.OAuth2Request\0\0\0\0\0\0\0\0Z\0approvedL\0authoritiesq\0~\0L\0\nextensionst\0Ljava/util/Map;L\0redirectUriq\0~\0L\0refresht\0;Lorg/springframework/security/oauth2ClientDetail/provider/TokenRequest;L\0resourceIdst\0Ljava/util/Set;L\0\rresponseTypesq\0~\0xr\08org.springframework.security.oauth2ClientDetail.provider.BaseRequest6(z>�qi�\0L\0clientIdq\0~\0L\0requestParametersq\0~\0L\0scopeq\0~\0xpt\0adminsr\0%java.util.Collections$UnmodifiableMap��t�B\0L\0mq\0~\0xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\ngrant_typet\0passwordt\0usernamet\0adminxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xq\0~\0	sr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0\Z?@\0\0\0\0\0\0w\0\0\0\0\0\0\0xppsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsr\0Oorg.springframework.security.authentication.UsernamePasswordAuthenticationToken\0\0\0\0\0\0�\0L\0credentialsq\0~\0L\0	principalq\0~\0xq\0~\0sq\0~\0sq\0~\0\0\0\0w\0\0\0q\0~\0xq\0~\0/sr\0java.util.LinkedHashMap4�N\\l��\0Z\0accessOrderxq\0~\0\Z?@\0\0\0\0\0w\0\0\0\0\0\0q\0~\0q\0~\0q\0~\0q\0~\0x\0psr\02org.springframework.security.core.userdetails.User\0\0\0\0\0\0�\0Z\0accountNonExpiredZ\0accountNonLockedZ\0credentialsNonExpiredZ\0enabledL\0authoritiesq\0~\0L\0passwordq\0~\0L\0usernameq\0~\0xpsq\0~\0 sr\0java.util.TreeSetݘP��\�[\0\0xpsr\0Forg.springframework.security.core.userdetails.User$AuthorityComparator\0\0\0\0\0\0�\0\0xpw\0\0\0q\0~\0xpt\0admin','69de1f9b28a73b82764f600510faba62'),('56009bf7ee4032dedfb8956086f5b791','�\�\0sr\0Corg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2AccessToken��6$�\�\0L\0additionalInformationt\0Ljava/util/Map;L\0\nexpirationt\0Ljava/util/Date;L\0refreshTokent\0?Lorg/springframework/security/oauth2ClientDetail/common/OAuth2RefreshToken;L\0scopet\0Ljava/util/Set;L\0	tokenTypet\0Ljava/lang/String;L\0valueq\0~\0xpsr\0java.util.Collections$EmptyMapY6�Z\�\�\�\0\0xpsr\0java.util.Datehj�KYt\0\0xpw\0\0iI�|xsr\0Lorg.springframework.security.oauth2ClientDetail.common.DefaultExpiringOAuth2RefreshToken/\�Gc�\�ɷ\0L\0\nexpirationq\0~\0xr\0Dorg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2RefreshTokens\�\ncT\�^\0L\0valueq\0~\0xpt\0$cad2d048-1b3d-4888-bb80-91ac347274b3sq\0~\0	w\0\0i\�	N{xsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0ct\0Ljava/util/Collection;xpsr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxt\0bearert\0$294ce09f-2fac-4ef8-974a-bd789babc9c9','e2c44e5dca49668ee9df2135279c26ea','admin','client2','�\�\0sr\0Aorg.springframework.security.oauth2ClientDetail.provider.OAuth2Authentication�@bR\0L\0\rstoredRequestt\0<Lorg/springframework/security/oauth2ClientDetail/provider/OAuth2Request;L\0userAuthenticationt\02Lorg/springframework/security/core/Authentication;xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailst\0Ljava/lang/Object;xp\0sr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0w\0\0\0sr\0Borg.springframework.security.core.authority.SimpleGrantedAuthority\0\0\0\0\0\0�\0L\0rolet\0Ljava/lang/String;xpt\0	ROLE_USERxq\0~\0psr\0:org.springframework.security.oauth2ClientDetail.provider.OAuth2Request\0\0\0\0\0\0\0\0Z\0approvedL\0authoritiesq\0~\0L\0\nextensionst\0Ljava/util/Map;L\0redirectUriq\0~\0L\0refresht\0;Lorg/springframework/security/oauth2ClientDetail/provider/TokenRequest;L\0resourceIdst\0Ljava/util/Set;L\0\rresponseTypesq\0~\0xr\08org.springframework.security.oauth2ClientDetail.provider.BaseRequest6(z>�qi�\0L\0clientIdq\0~\0L\0requestParametersq\0~\0L\0scopeq\0~\0xpt\0client2sr\0%java.util.Collections$UnmodifiableMap��t�B\0L\0mq\0~\0xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\ngrant_typet\0passwordt\0usernamet\0adminxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xq\0~\0	sr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0\Z?@\0\0\0\0\0\0w\0\0\0\0\0\0\0xppsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsr\0Oorg.springframework.security.authentication.UsernamePasswordAuthenticationToken\0\0\0\0\0\0�\0L\0credentialsq\0~\0L\0	principalq\0~\0xq\0~\0sq\0~\0sq\0~\0\0\0\0w\0\0\0q\0~\0xq\0~\0/sr\0java.util.LinkedHashMap4�N\\l��\0Z\0accessOrderxq\0~\0\Z?@\0\0\0\0\0w\0\0\0\0\0\0q\0~\0q\0~\0q\0~\0q\0~\0x\0psr\02org.springframework.security.core.userdetails.User\0\0\0\0\0\0�\0Z\0accountNonExpiredZ\0accountNonLockedZ\0credentialsNonExpiredZ\0enabledL\0authoritiesq\0~\0L\0passwordq\0~\0L\0usernameq\0~\0xpsq\0~\0 sr\0java.util.TreeSetݘP��\�[\0\0xpsr\0Forg.springframework.security.core.userdetails.User$AuthorityComparator\0\0\0\0\0\0�\0\0xpw\0\0\0q\0~\0xpt\0admin','e18c9750c8245cd0498ce3d3e5ef95f9'),('adb3f07ecf59eeb131ac348531b1199f','�\�\0sr\0Corg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2AccessToken��6$�\�\0L\0additionalInformationt\0Ljava/util/Map;L\0\nexpirationt\0Ljava/util/Date;L\0refreshTokent\0?Lorg/springframework/security/oauth2ClientDetail/common/OAuth2RefreshToken;L\0scopet\0Ljava/util/Set;L\0	tokenTypet\0Ljava/lang/String;L\0valueq\0~\0xpsr\0java.util.Collections$EmptyMapY6�Z\�\�\�\0\0xpsr\0java.util.Datehj�KYt\0\0xpw\0\0i�\�I�xsr\0Lorg.springframework.security.oauth2ClientDetail.common.DefaultExpiringOAuth2RefreshToken/\�Gc�\�ɷ\0L\0\nexpirationq\0~\0xr\0Dorg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2RefreshTokens\�\ncT\�^\0L\0valueq\0~\0xpt\0$6f332e4c-cb2d-4fa8-8737-7d76a2ed1673sq\0~\0	w\0\0j��xsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0ct\0Ljava/util/Collection;xpsr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxt\0bearert\0$3dc4eeed-8ebb-4f55-8e93-4d9163c5ba61','f56857b08844a1626a031eb521523cab',NULL,'client2','�\�\0sr\0Aorg.springframework.security.oauth2ClientDetail.provider.OAuth2Authentication�@bR\0L\0\rstoredRequestt\0<Lorg/springframework/security/oauth2ClientDetail/provider/OAuth2Request;L\0userAuthenticationt\02Lorg/springframework/security/core/Authentication;xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailst\0Ljava/lang/Object;xp\0sr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0\0w\0\0\0\0xq\0~\0psr\0:org.springframework.security.oauth2ClientDetail.provider.OAuth2Request\0\0\0\0\0\0\0\0Z\0approvedL\0authoritiesq\0~\0L\0\nextensionst\0Ljava/util/Map;L\0redirectUrit\0Ljava/lang/String;L\0refresht\0;Lorg/springframework/security/oauth2ClientDetail/provider/TokenRequest;L\0resourceIdst\0Ljava/util/Set;L\0\rresponseTypesq\0~\0xr\08org.springframework.security.oauth2ClientDetail.provider.BaseRequest6(z>�qi�\0L\0clientIdq\0~\0L\0requestParametersq\0~\0L\0scopeq\0~\0xpt\0client2sr\0%java.util.Collections$UnmodifiableMap��t�B\0L\0mq\0~\0xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\ngrant_typet\0client_credentialsxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xq\0~\0	sr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxsq\0~\0w\0\0\0?@\0\0\0\0\0\0xsq\0~\0?@\0\0\0\0\0\0w\0\0\0\0\0\0\0xppsq\0~\0w\0\0\0?@\0\0\0\0\0\0xsq\0~\0w\0\0\0?@\0\0\0\0\0\0xp','a520e46125f32f3bfeb84e15e0d24a5c');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='oauth2ClientDetail client 관련 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oauth_client_details` VALUES ('admin',NULL,'$2a$10$mjdy4EWVlfSCv/tTt3t1LuxRMuJn4eJtaJv23x/MR7eScbvwDBi/C','read,write,trust','password,authorization_code,refresh_token,implicit,client_credentials',NULL,NULL,43200,2592000,NULL,'true'),('client2',NULL,'$2a$09$9Tk.mANFSEcOTDUQgCMGs.ZqjfeSIbWdQv2VM/gV5TOHFuwtUbz8e','read,write,trust','password,authorization_code,refresh_token,implicit,client_credentials',NULL,NULL,43200,2592000,NULL,'true'),('test',NULL,'$2a$10$mjdy4EWVlfSCv/tTt3t1LuxRMuJn4eJtaJv23x/MR7eScbvwDBi/C','read','implicit','http://localhost:5000/api/v1',NULL,43200,2592000,NULL,'true');
...
INSERT INTO `oauth_refresh_token` VALUES ('69de1f9b28a73b82764f600510faba62','�\�\0sr\0Lorg.springframework.security.oauth2ClientDetail.common.DefaultExpiringOAuth2RefreshToken/\�Gc�\�ɷ\0L\0\nexpirationt\0Ljava/util/Date;xr\0Dorg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2RefreshTokens\�\ncT\�^\0L\0valuet\0Ljava/lang/String;xpt\0$7a7042f4-f4e2-426d-abbe-400d65ff95edsr\0java.util.Datehj�KYt\0\0xpw\0\0i\��Vx','�\�\0sr\0Aorg.springframework.security.oauth2ClientDetail.provider.OAuth2Authentication�@bR\0L\0\rstoredRequestt\0<Lorg/springframework/security/oauth2ClientDetail/provider/OAuth2Request;L\0userAuthenticationt\02Lorg/springframework/security/core/Authentication;xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailst\0Ljava/lang/Object;xp\0sr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0w\0\0\0sr\0Borg.springframework.security.core.authority.SimpleGrantedAuthority\0\0\0\0\0\0�\0L\0rolet\0Ljava/lang/String;xpt\0	ROLE_USERxq\0~\0psr\0:org.springframework.security.oauth2ClientDetail.provider.OAuth2Request\0\0\0\0\0\0\0\0Z\0approvedL\0authoritiesq\0~\0L\0\nextensionst\0Ljava/util/Map;L\0redirectUriq\0~\0L\0refresht\0;Lorg/springframework/security/oauth2ClientDetail/provider/TokenRequest;L\0resourceIdst\0Ljava/util/Set;L\0\rresponseTypesq\0~\0xr\08org.springframework.security.oauth2ClientDetail.provider.BaseRequest6(z>�qi�\0L\0clientIdq\0~\0L\0requestParametersq\0~\0L\0scopeq\0~\0xpt\0adminsr\0%java.util.Collections$UnmodifiableMap��t�B\0L\0mq\0~\0xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\ngrant_typet\0passwordt\0usernamet\0adminxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xq\0~\0	sr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0\Z?@\0\0\0\0\0\0w\0\0\0\0\0\0\0xppsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsr\0Oorg.springframework.security.authentication.UsernamePasswordAuthenticationToken\0\0\0\0\0\0�\0L\0credentialsq\0~\0L\0	principalq\0~\0xq\0~\0sq\0~\0sq\0~\0\0\0\0w\0\0\0q\0~\0xq\0~\0/sr\0java.util.LinkedHashMap4�N\\l��\0Z\0accessOrderxq\0~\0\Z?@\0\0\0\0\0w\0\0\0\0\0\0q\0~\0q\0~\0q\0~\0q\0~\0x\0psr\02org.springframework.security.core.userdetails.User\0\0\0\0\0\0�\0Z\0accountNonExpiredZ\0accountNonLockedZ\0credentialsNonExpiredZ\0enabledL\0authoritiesq\0~\0L\0passwordq\0~\0L\0usernameq\0~\0xpsq\0~\0 sr\0java.util.TreeSetݘP��\�[\0\0xpsr\0Forg.springframework.security.core.userdetails.User$AuthorityComparator\0\0\0\0\0\0�\0\0xpw\0\0\0q\0~\0xpt\0admin'),('e18c9750c8245cd0498ce3d3e5ef95f9','�\�\0sr\0Lorg.springframework.security.oauth2ClientDetail.common.DefaultExpiringOAuth2RefreshToken/\�Gc�\�ɷ\0L\0\nexpirationt\0Ljava/util/Date;xr\0Dorg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2RefreshTokens\�\ncT\�^\0L\0valuet\0Ljava/lang/String;xpt\0$cad2d048-1b3d-4888-bb80-91ac347274b3sr\0java.util.Datehj�KYt\0\0xpw\0\0i\�	N{x','�\�\0sr\0Aorg.springframework.security.oauth2ClientDetail.provider.OAuth2Authentication�@bR\0L\0\rstoredRequestt\0<Lorg/springframework/security/oauth2ClientDetail/provider/OAuth2Request;L\0userAuthenticationt\02Lorg/springframework/security/core/Authentication;xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailst\0Ljava/lang/Object;xp\0sr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0w\0\0\0sr\0Borg.springframework.security.core.authority.SimpleGrantedAuthority\0\0\0\0\0\0�\0L\0rolet\0Ljava/lang/String;xpt\0	ROLE_USERxq\0~\0psr\0:org.springframework.security.oauth2ClientDetail.provider.OAuth2Request\0\0\0\0\0\0\0\0Z\0approvedL\0authoritiesq\0~\0L\0\nextensionst\0Ljava/util/Map;L\0redirectUriq\0~\0L\0refresht\0;Lorg/springframework/security/oauth2ClientDetail/provider/TokenRequest;L\0resourceIdst\0Ljava/util/Set;L\0\rresponseTypesq\0~\0xr\08org.springframework.security.oauth2ClientDetail.provider.BaseRequest6(z>�qi�\0L\0clientIdq\0~\0L\0requestParametersq\0~\0L\0scopeq\0~\0xpt\0client2sr\0%java.util.Collections$UnmodifiableMap��t�B\0L\0mq\0~\0xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\ngrant_typet\0passwordt\0usernamet\0adminxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xq\0~\0	sr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0\Z?@\0\0\0\0\0\0w\0\0\0\0\0\0\0xppsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsq\0~\0#w\0\0\0?@\0\0\0\0\0\0xsr\0Oorg.springframework.security.authentication.UsernamePasswordAuthenticationToken\0\0\0\0\0\0�\0L\0credentialsq\0~\0L\0	principalq\0~\0xq\0~\0sq\0~\0sq\0~\0\0\0\0w\0\0\0q\0~\0xq\0~\0/sr\0java.util.LinkedHashMap4�N\\l��\0Z\0accessOrderxq\0~\0\Z?@\0\0\0\0\0w\0\0\0\0\0\0q\0~\0q\0~\0q\0~\0q\0~\0x\0psr\02org.springframework.security.core.userdetails.User\0\0\0\0\0\0�\0Z\0accountNonExpiredZ\0accountNonLockedZ\0credentialsNonExpiredZ\0enabledL\0authoritiesq\0~\0L\0passwordq\0~\0L\0usernameq\0~\0xpsq\0~\0 sr\0java.util.TreeSetݘP��\�[\0\0xpsr\0Forg.springframework.security.core.userdetails.User$AuthorityComparator\0\0\0\0\0\0�\0\0xpw\0\0\0q\0~\0xpt\0admin'),('f9a521c7d9192dcb7ed0f5ee63d30fcf','�\�\0sr\0Lorg.springframework.security.oauth2ClientDetail.common.DefaultExpiringOAuth2RefreshToken/\�Gc�\�ɷ\0L\0\nexpirationt\0Ljava/util/Date;xr\0Dorg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2RefreshTokens\�\ncT\�^\0L\0valuet\0Ljava/lang/String;xpt\0$570fe9ba-1ee7-411c-8087-289fc7a450f0sr\0java.util.Datehj�KYt\0\0xpw\0\0j�\Z�x','�\�\0sr\0Aorg.springframework.security.oauth2ClientDetail.provider.OAuth2Authentication�@bR\0L\0\rstoredRequestt\0<Lorg/springframework/security/oauth2ClientDetail/provider/OAuth2Request;L\0userAuthenticationt\02Lorg/springframework/security/core/Authentication;xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailst\0Ljava/lang/Object;xp\0sr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0\0w\0\0\0\0xq\0~\0psr\0:org.springframework.security.oauth2ClientDetail.provider.OAuth2Request\0\0\0\0\0\0\0\0Z\0approvedL\0authoritiesq\0~\0L\0\nextensionst\0Ljava/util/Map;L\0redirectUrit\0Ljava/lang/String;L\0refresht\0;Lorg/springframework/security/oauth2ClientDetail/provider/TokenRequest;L\0resourceIdst\0Ljava/util/Set;L\0\rresponseTypesq\0~\0xr\08org.springframework.security.oauth2ClientDetail.provider.BaseRequest6(z>�qi�\0L\0clientIdq\0~\0L\0requestParametersq\0~\0L\0scopeq\0~\0xpt\0client2sr\0%java.util.Collections$UnmodifiableMap��t�B\0L\0mq\0~\0xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\ngrant_typet\0client_credentialsxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xq\0~\0	sr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxsq\0~\0w\0\0\0?@\0\0\0\0\0\0xsq\0~\0?@\0\0\0\0\0\0w\0\0\0\0\0\0\0xppsq\0~\0w\0\0\0?@\0\0\0\0\0\0xsq\0~\0w\0\0\0?@\0\0\0\0\0\0xp'),('a520e46125f32f3bfeb84e15e0d24a5c','�\�\0sr\0Lorg.springframework.security.oauth2ClientDetail.common.DefaultExpiringOAuth2RefreshToken/\�Gc�\�ɷ\0L\0\nexpirationt\0Ljava/util/Date;xr\0Dorg.springframework.security.oauth2ClientDetail.common.DefaultOAuth2RefreshTokens\�\ncT\�^\0L\0valuet\0Ljava/lang/String;xpt\0$6f332e4c-cb2d-4fa8-8737-7d76a2ed1673sr\0java.util.Datehj�KYt\0\0xpw\0\0j��x','�\�\0sr\0Aorg.springframework.security.oauth2ClientDetail.provider.OAuth2Authentication�@bR\0L\0\rstoredRequestt\0<Lorg/springframework/security/oauth2ClientDetail/provider/OAuth2Request;L\0userAuthenticationt\02Lorg/springframework/security/core/Authentication;xr\0Gorg.springframework.security.authentication.AbstractAuthenticationTokenӪ(~nGd\0Z\0\rauthenticatedL\0authoritiest\0Ljava/util/Collection;L\0detailst\0Ljava/lang/Object;xp\0sr\0&java.util.Collections$UnmodifiableList�%1�\�\0L\0listt\0Ljava/util/List;xr\0,java.util.Collections$UnmodifiableCollectionB\0�\�^�\0L\0cq\0~\0xpsr\0java.util.ArrayListx�\��\�a�\0I\0sizexp\0\0\0\0w\0\0\0\0xq\0~\0psr\0:org.springframework.security.oauth2ClientDetail.provider.OAuth2Request\0\0\0\0\0\0\0\0Z\0approvedL\0authoritiesq\0~\0L\0\nextensionst\0Ljava/util/Map;L\0redirectUrit\0Ljava/lang/String;L\0refresht\0;Lorg/springframework/security/oauth2ClientDetail/provider/TokenRequest;L\0resourceIdst\0Ljava/util/Set;L\0\rresponseTypesq\0~\0xr\08org.springframework.security.oauth2ClientDetail.provider.BaseRequest6(z>�qi�\0L\0clientIdq\0~\0L\0requestParametersq\0~\0L\0scopeq\0~\0xpt\0client2sr\0%java.util.Collections$UnmodifiableMap��t�B\0L\0mq\0~\0xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\ngrant_typet\0client_credentialsxsr\0%java.util.Collections$UnmodifiableSet��я��U\0\0xq\0~\0	sr\0java.util.LinkedHashSet\�l\�Z�\�*\0\0xr\0java.util.HashSet�D�����4\0\0xpw\0\0\0?@\0\0\0\0\0t\0readt\0writet\0trustxsq\0~\0w\0\0\0?@\0\0\0\0\0\0xsq\0~\0?@\0\0\0\0\0\0w\0\0\0\0\0\0\0xppsq\0~\0w\0\0\0?@\0\0\0\0\0\0xsq\0~\0w\0\0\0?@\0\0\0\0\0\0xp');
...
CREATE TABLE `order_tbl` (
  ...
  CONSTRAINT `fk_order_cust` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='주문 목록 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reply_for_comment_all_tbl` (
  ...
  CONSTRAINT `fk_reply_customer_all` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `reply_for_comment_store_tbl` (
  ...
  CONSTRAINT `fk_reply_customer_store` FOREIGN KEY (`customer_idx`) REFERENCES `user_tbl` (`idx`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='본 서비스를 사용하게 되는 사용자에 관한 테이블\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-07 21:22:56
