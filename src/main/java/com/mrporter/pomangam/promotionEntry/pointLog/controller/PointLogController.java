...
public class PointLogController {
    ...
    @GetMapping("/search/getPointPctPrc")
    public ResponseEntity<?> getPointPctPrc(@RequestParam(value = "customerIdx", required = false) Integer customerIdx) {
        return new ResponseEntity(pointLogService.getPointPctPrc(customerIdx), HttpStatus.OK);
    }
}
