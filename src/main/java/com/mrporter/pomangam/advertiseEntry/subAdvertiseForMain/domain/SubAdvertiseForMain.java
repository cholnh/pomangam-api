...
@Table(name = "sub_advertise_for_main_tbl")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@Data
@Entity
public class SubAdvertiseForMain {
    @Id
    ...
    @Builder
    public SubAdvertiseForMain(String imgpath, Byte next_step_type, String next_step_location, Byte state_active, Integer sequence) {
