...
public interface StoreService {
    ...
    List<InquiryResultDto> getInquiryResult(LocalDateTime arrival_date, Integer delivery_site_idx);

    List<InquiryResultDto> getInquiryResult(LocalDateTime arrival_date, Integer delivery_site_idx, ZoneId zoneId);
}
