...
public class CommentStoreViewDto implements Serializable {
    ...
    @Builder
    public CommentStoreViewDto(Integer idx, Integer store_idx, String customer_nickname, String customer_id, Float cnt_star, Integer cnt_like, String contents, Timestamp register_date, Byte state_anonymous, Byte likeType) {
        this.idx = idx;
