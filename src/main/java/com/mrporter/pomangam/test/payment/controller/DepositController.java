...
public class DepositController {
    ...
    public String get(HttpServletRequest request) {
        ...
        String account = "59800101361949";
        String id = "MRPORTER92";
        String password = "0272";
        ...
        try {
            ...
            Connection.Response response = Jsoup.connect("https://obank.kbstar.com/quics?asfilecode=524517")
