...
public class PaymentTestController {
    ...
    public ResponseEntity<?> serverSideWork(@RequestBody PaymentInputDto dto) {
    ...
    public ResponseEntity<?> complete(@RequestParam(name = "imp_uid") String imp_uid,
                                      @RequestParam(name = "merchant_uid") String merchant_uid) {
        PaymentResultDto pdto = new PaymentResultDto(imp_uid, merchant_uid);
        return complete(pdto);
    }

    @PostMapping("/complete")
    public ResponseEntity<?> complete(@RequestBody PaymentResultDto pdto) {
        Integer orderIdx = null;
        try {
