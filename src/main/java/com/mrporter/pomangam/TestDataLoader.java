...
import com.mrporter.pomangam.client.repositories.deliverysite.detail.DetailJpaRepository;
...
public class TestDataLoader implements ApplicationRunner {
    ...
    @Autowired DetailJpaRepository detailJpaRepository;
    ...
    void run() {
        ...
        System.err.println("detail2 : "+detail2);
