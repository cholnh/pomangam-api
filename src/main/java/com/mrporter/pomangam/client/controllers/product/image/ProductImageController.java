package com.mrporter.pomangam.client.controllers.product.image;
...
@RestController
@RequestMapping("/dsites/{didx}/stores/{sidx}/products/{pidx}/images")
@AllArgsConstructor
public class ProductImageController {
    ...
    public ResponseEntity<?> get(
            ...
            @PathVariable(value = "pidx", required = true) Integer pidx,
