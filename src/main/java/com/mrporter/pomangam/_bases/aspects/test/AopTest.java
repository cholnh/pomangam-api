...
public class AopTest {
    ...
    @Pointcut("execution(* com.mrporter.pomangam._bases.aspects.test.RealClass.doSomething_1(..))")
    public void fun_1() {
    }

    @Pointcut("execution(* com.mrporter.pomangam._bases.aspects.test.RealClass.doSomething_2(..))")
    public void fun_2() {
    }
